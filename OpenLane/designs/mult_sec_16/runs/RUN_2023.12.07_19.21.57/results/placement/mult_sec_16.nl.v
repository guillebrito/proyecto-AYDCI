module mult_sec_16 (clk,
 ...
 sky130_fd_sc_hd__inv_2 _244_ (.A(_043_),
    .Y(_044_));
 sky130_fd_sc_hd__clkbuf_4 _245_ (.A(_044_),
    .X(_000_));
 ...
 sky130_fd_sc_hd__and4b_1 _247_ (.A_N(\cnt_act[4] ),
    ...
    .D(\cnt_act[0] ),
    .X(_046_));
 sky130_fd_sc_hd__a21boi_1 _248_ (.A1(\cnt_act[2] ),
    .A2(_046_),
    .B1_N(_042_),
    .Y(_047_));
 ...
 sky130_fd_sc_hd__or2_1 _254_ (.A(\estado_act[1] ),
    .B(_042_),
    .X(_052_));
 sky130_fd_sc_hd__clkbuf_2 _255_ (.A(_052_),
    .X(_053_));
 sky130_fd_sc_hd__buf_2 _256_ (.A(_053_),
    .X(_054_));
 sky130_fd_sc_hd__and2_1 _257_ (.A(_040_),
    .B(_041_),
    .X(_055_));
 sky130_fd_sc_hd__clkbuf_2 _258_ (.A(_055_),
    .X(_056_));
 ...
 sky130_fd_sc_hd__a221o_1 _270_ (.A1(net44),
    ...
    .C1(_045_),
    .X(_067_));
 sky130_fd_sc_hd__o211a_1 _271_ (.A1(net43),
    .A2(_057_),
    .B1(_061_),
    .C1(_067_),
    .X(_003_));
 sky130_fd_sc_hd__nor2_1 _272_ (.A(net43),
    .B(net8),
    .Y(_068_));
 sky130_fd_sc_hd__o21ai_1 _273_ (.A1(_048_),
    .A2(_068_),
    .B1(_062_),
    .Y(_069_));
 ...
 sky130_fd_sc_hd__a31o_1 _389_ (.A1(_050_),
    ...
    .B1(_173_),
    .X(_174_));
 sky130_fd_sc_hd__nand2_1 _390_ (.A(net56),
    .B(_045_),
    .Y(_175_));
 sky130_fd_sc_hd__nor2_4 _391_ (.A(_059_),
    .B(_041_),
    .Y(_176_));
 sky130_fd_sc_hd__clkbuf_4 _392_ (.A(_176_),
    .X(_177_));
 sky130_fd_sc_hd__a21oi_1 _393_ (.A1(_174_),
    .A2(_175_),
    .B1(_177_),
    .Y(_015_));
 sky130_fd_sc_hd__nand2_1 _394_ (.A(net58),
    .B(_045_),
    .Y(_178_));
 ...
 sky130_fd_sc_hd__a31o_1 _411_ (.A1(_050_),
    ...
    .B1(_193_),
    .X(_194_));
 sky130_fd_sc_hd__nand2_1 _412_ (.A(net59),
    .B(_045_),
    .Y(_195_));
 ...
 sky130_fd_sc_hd__mux2_1 _424_ (.A0(net60),
    ...
    .S(_177_),
    .X(_203_));
 sky130_fd_sc_hd__mux2_1 _425_ (.A0(net57),
    .A1(_203_),
    .S(_000_),
    .X(_204_));
 ...
 sky130_fd_sc_hd__mux2_1 _460_ (.A0(net41),
    ...
    .S(_176_),
    .X(_227_));
 sky130_fd_sc_hd__mux2_1 _461_ (.A0(net40),
    .A1(_227_),
    .S(_044_),
    .X(_228_));
 ...
 sky130_fd_sc_hd__nor2_1 _470_ (.A(net33),
    .B(_233_),
    .Y(_234_));
 sky130_fd_sc_hd__o21a_1 _471_ (.A1(\cnt_act[1] ),
    .A2(_232_),
    .B1(_234_),
    .X(_036_));
 ...
 sky130_fd_sc_hd__nor2_1 _473_ (.A(net33),
    .B(_235_),
    .Y(_236_));
 sky130_fd_sc_hd__o21a_1 _474_ (.A1(\cnt_act[2] ),
    .A2(_233_),
    .B1(_236_),
    .X(_037_));
 sky130_fd_sc_hd__a21oi_1 _475_ (.A1(\cnt_act[3] ),
    .A2(_235_),
    .B1(net33),
    .Y(_237_));
 sky130_fd_sc_hd__o21a_1 _476_ (.A1(\cnt_act[3] ),
    .A2(_235_),
    .B1(_237_),
    .X(_038_));
 sky130_fd_sc_hd__and2_1 _477_ (.A(\cnt_act[4] ),
    .B(_237_),
    .X(_238_));
 ...
 sky130_fd_sc_hd__buf_1 input14 (.A(mcand[7]),
    .X(net14));
 sky130_fd_sc_hd__dlymetal6s2s_1 input15 (.A(mcand[8]),
    .X(net15));
 sky130_fd_sc_hd__dlymetal6s2s_1 input16 (.A(mcand[9]),
    .X(net16));
 ...
 sky130_fd_sc_hd__clkbuf_1 input31 (.A(mplier[8]),
    .X(net31));
 sky130_fd_sc_hd__clkbuf_1 input32 (.A(mplier[9]),
    .X(net32));
