module mult_sec_32 (clk,
 ...
 sky130_fd_sc_hd__inv_2 _431_ (.A(net65),
    .Y(_074_));
 sky130_fd_sc_hd__nor2_1 _432_ (.A(\estado_act[1] ),
    .B(\estado_act[0] ),
    .Y(_075_));
 sky130_fd_sc_hd__o21ai_1 _433_ (.A1(\estado_act[1] ),
    ...
    .B1(\estado_act[0] ),
    .Y(_076_));
 sky130_fd_sc_hd__a21bo_1 _434_ (.A1(_074_),
    .A2(_075_),
    .B1_N(_076_),
    .X(_077_));
 sky130_fd_sc_hd__inv_2 _435_ (.A(_077_),
    .Y(_078_));
 sky130_fd_sc_hd__buf_2 _436_ (.A(_078_),
    .X(_000_));
 ...
 sky130_fd_sc_hd__o211a_1 _458_ (.A1(_088_),
    ...
    .C1(_098_),
    .X(_002_));
 sky130_fd_sc_hd__nor2_1 _459_ (.A(net66),
    .B(_075_),
    .Y(_099_));
 ...
 sky130_fd_sc_hd__and3_1 _491_ (.A(net94),
    ...
    .C(_127_),
    .X(_128_));
 sky130_fd_sc_hd__a311o_1 _492_ (.A1(_111_),
    .A2(_114_),
    .A3(_127_),
    .B1(_119_),
    .C1(_128_),
 ...
 sky130_fd_sc_hd__o221a_1 _545_ (.A1(net102),
    ...
    .C1(_098_),
    .X(_011_));
 sky130_fd_sc_hd__buf_2 _546_ (.A(_097_),
    .X(_177_));
 ...
 sky130_fd_sc_hd__or2b_1 _556_ (.A(_178_),
    .B_N(_180_),
    .X(_186_));
 sky130_fd_sc_hd__xnor2_1 _557_ (.A(net104),
    .B(net3),
    .Y(_187_));
 ...
 sky130_fd_sc_hd__clkbuf_1 _751_ (.A(_361_),
    .X(_032_));
 sky130_fd_sc_hd__nand2_1 _752_ (.A(net126),
    .B(_080_),
    .Y(_362_));
 ...
 sky130_fd_sc_hd__a21oi_1 _764_ (.A1(_362_),
    ...
    .B1(_373_),
    .Y(_033_));
 sky130_fd_sc_hd__nand2_1 _765_ (.A(\acu_act[64] ),
    .B(_080_),
    .Y(_374_));
 ...
 sky130_fd_sc_hd__clkbuf_4 _770_ (.A(_377_),
    .X(_378_));
 sky130_fd_sc_hd__buf_2 _771_ (.A(_077_),
    .X(_379_));
 ...
 sky130_fd_sc_hd__a221o_1 _774_ (.A1(net44),
    ...
    .C1(_379_),
    .X(_381_));
 sky130_fd_sc_hd__o21a_1 _775_ (.A1(net78),
    .A2(_000_),
    .B1(_381_),
    .X(_036_));
 sky130_fd_sc_hd__a221o_1 _776_ (.A1(net55),
    ...
    .C1(_379_),
    .X(_382_));
 sky130_fd_sc_hd__o21a_1 _777_ (.A1(net89),
    .A2(_000_),
    .B1(_382_),
    .X(_037_));
 ...
 sky130_fd_sc_hd__a221o_1 _780_ (.A1(net59),
    ...
    .C1(_379_),
    .X(_384_));
 sky130_fd_sc_hd__o21a_1 _781_ (.A1(net111),
    .A2(_000_),
    .B1(_384_),
    .X(_039_));
 sky130_fd_sc_hd__a221o_1 _782_ (.A1(net60),
    ...
    .C1(_379_),
    .X(_385_));
 sky130_fd_sc_hd__o21a_1 _783_ (.A1(net122),
    .A2(_000_),
    .B1(_385_),
    .X(_040_));
 sky130_fd_sc_hd__a221o_1 _784_ (.A1(net61),
    ...
    .C1(_379_),
    .X(_386_));
 sky130_fd_sc_hd__o21a_1 _785_ (.A1(net127),
    .A2(_000_),
    .B1(_386_),
    .X(_041_));
 sky130_fd_sc_hd__a221o_1 _786_ (.A1(net62),
    ...
    .C1(_379_),
    .X(_387_));
 sky130_fd_sc_hd__o21a_1 _787_ (.A1(net128),
    .A2(_000_),
    .B1(_387_),
    .X(_042_));
 sky130_fd_sc_hd__buf_2 _788_ (.A(_372_),
    .X(_388_));
 ...
 sky130_fd_sc_hd__a221o_1 _792_ (.A1(net64),
    ...
    .C1(_379_),
    .X(_391_));
 sky130_fd_sc_hd__o21a_1 _793_ (.A1(net130),
    .A2(_390_),
    .B1(_391_),
    .X(_044_));
 sky130_fd_sc_hd__buf_2 _794_ (.A(_377_),
    .X(_392_));
 sky130_fd_sc_hd__buf_2 _795_ (.A(_077_),
    .X(_393_));
 ...
 sky130_fd_sc_hd__a221o_1 _798_ (.A1(net35),
    ...
    .C1(_393_),
    .X(_395_));
 sky130_fd_sc_hd__o21a_1 _799_ (.A1(net69),
    .A2(_390_),
    .B1(_395_),
    .X(_046_));
 sky130_fd_sc_hd__a221o_1 _800_ (.A1(net36),
    ...
    .C1(_393_),
    .X(_396_));
 sky130_fd_sc_hd__o21a_1 _801_ (.A1(net70),
    .A2(_390_),
    .B1(_396_),
    .X(_047_));
 sky130_fd_sc_hd__a221o_1 _802_ (.A1(net37),
    ...
    .C1(_393_),
    .X(_397_));
 sky130_fd_sc_hd__o21a_1 _803_ (.A1(net71),
    .A2(_390_),
    .B1(_397_),
    .X(_048_));
 sky130_fd_sc_hd__a221o_1 _804_ (.A1(net38),
    ...
    .C1(_393_),
    .X(_398_));
 sky130_fd_sc_hd__o21a_1 _805_ (.A1(net72),
    .A2(_390_),
    .B1(_398_),
    .X(_049_));
 sky130_fd_sc_hd__a221o_1 _806_ (.A1(net39),
    ...
    .C1(_393_),
    .X(_399_));
 sky130_fd_sc_hd__o21a_1 _807_ (.A1(net73),
    .A2(_390_),
    .B1(_399_),
    .X(_050_));
 ...
 sky130_fd_sc_hd__a221o_1 _810_ (.A1(net41),
    ...
    .C1(_393_),
    .X(_401_));
 sky130_fd_sc_hd__o21a_1 _811_ (.A1(net75),
    .A2(_390_),
    .B1(_401_),
    .X(_052_));
 sky130_fd_sc_hd__buf_2 _812_ (.A(_372_),
    .X(_402_));
 sky130_fd_sc_hd__a221o_1 _813_ (.A1(net42),
    ...
    .C1(_393_),
    .X(_403_));
 sky130_fd_sc_hd__o21a_1 _814_ (.A1(net76),
    .A2(_390_),
    .B1(_403_),
    .X(_053_));
 sky130_fd_sc_hd__buf_2 _815_ (.A(_078_),
    .X(_404_));
 sky130_fd_sc_hd__a221o_1 _816_ (.A1(net43),
    ...
    .C1(_393_),
    .X(_405_));
 sky130_fd_sc_hd__o21a_1 _817_ (.A1(net77),
    .A2(_404_),
    .B1(_405_),
    .X(_054_));
 sky130_fd_sc_hd__buf_2 _818_ (.A(_377_),
    .X(_406_));
 sky130_fd_sc_hd__buf_2 _819_ (.A(_077_),
    .X(_407_));
 sky130_fd_sc_hd__a221o_1 _820_ (.A1(net45),
    ...
    .C1(_407_),
    .X(_408_));
 sky130_fd_sc_hd__o21a_1 _821_ (.A1(net79),
    .A2(_404_),
    .B1(_408_),
    .X(_055_));
 sky130_fd_sc_hd__a221o_1 _822_ (.A1(net46),
    ...
    .C1(_407_),
    .X(_409_));
 sky130_fd_sc_hd__o21a_1 _823_ (.A1(net80),
    .A2(_404_),
    .B1(_409_),
    .X(_056_));
 ...
 sky130_fd_sc_hd__a221o_1 _826_ (.A1(net48),
    ...
    .C1(_407_),
    .X(_411_));
 sky130_fd_sc_hd__o21a_1 _827_ (.A1(net82),
    .A2(_404_),
    .B1(_411_),
    .X(_058_));
 ...
 sky130_fd_sc_hd__a221o_1 _832_ (.A1(net51),
    ...
    .C1(_407_),
    .X(_414_));
 sky130_fd_sc_hd__o21a_1 _833_ (.A1(net85),
    .A2(_404_),
    .B1(_414_),
    .X(_061_));
 sky130_fd_sc_hd__a221o_1 _834_ (.A1(net52),
    ...
    .C1(_407_),
    .X(_415_));
 sky130_fd_sc_hd__o21a_1 _835_ (.A1(net86),
    .A2(_404_),
    .B1(_415_),
    .X(_062_));
 sky130_fd_sc_hd__a221o_1 _836_ (.A1(net53),
    ...
    .C1(_407_),
    .X(_416_));
 sky130_fd_sc_hd__o21a_1 _837_ (.A1(net87),
    .A2(_404_),
    .B1(_416_),
    .X(_063_));
 sky130_fd_sc_hd__a221o_1 _838_ (.A1(net54),
    ...
    .C1(_407_),
    .X(_417_));
 sky130_fd_sc_hd__o21a_1 _839_ (.A1(net88),
    .A2(_078_),
    .B1(_417_),
    .X(_064_));
 sky130_fd_sc_hd__a221o_1 _840_ (.A1(net56),
    ...
    .C1(_077_),
    .X(_418_));
 sky130_fd_sc_hd__o21a_1 _841_ (.A1(net90),
    .A2(_078_),
    .B1(_418_),
    .X(_065_));
 sky130_fd_sc_hd__a221o_1 _842_ (.A1(net57),
    ...
    .C1(_077_),
    .X(_419_));
 sky130_fd_sc_hd__o21a_1 _843_ (.A1(net91),
    .A2(_078_),
    .B1(_419_),
    .X(_066_));
 ...
 sky130_fd_sc_hd__o21ai_1 _848_ (.A1(\cnt_act[1] ),
    ...
    .B1(_074_),
    .Y(_423_));
 sky130_fd_sc_hd__a21oi_1 _849_ (.A1(\cnt_act[1] ),
    .A2(_422_),
    .B1(_423_),
    .Y(_068_));
 ...
 sky130_fd_sc_hd__nor3_1 _855_ (.A(net65),
    ...
    .C(_427_),
    .Y(_070_));
 sky130_fd_sc_hd__o21ai_1 _856_ (.A1(\cnt_act[4] ),
    .A2(_427_),
    .B1(_074_),
    .Y(_428_));
 sky130_fd_sc_hd__a21oi_1 _857_ (.A1(\cnt_act[4] ),
    .A2(_427_),
    .B1(_428_),
    .Y(_071_));
 ...
 sky130_fd_sc_hd__buf_1 input14 (.A(mcand[21]),
    .X(net14));
 sky130_fd_sc_hd__clkbuf_1 input15 (.A(mcand[22]),
    .X(net15));
 ...
 sky130_fd_sc_hd__buf_1 input19 (.A(mcand[26]),
    .X(net19));
 sky130_fd_sc_hd__dlymetal6s2s_1 input20 (.A(mcand[27]),
    .X(net20));
 ...
 sky130_fd_sc_hd__clkbuf_1 input31 (.A(mcand[8]),
    .X(net31));
 sky130_fd_sc_hd__buf_1 input32 (.A(mcand[9]),
    .X(net32));
 ...
 sky130_fd_sc_hd__clkbuf_1 input61 (.A(mplier[6]),
    .X(net61));
 sky130_fd_sc_hd__buf_1 input62 (.A(mplier[7]),
    .X(net62));
